-- ============================================================
-- MATERNAL CHILD CARE SERVICE - DATABASE SETUP FOR SUPABASE
...
(1, 'Dr. Silva', 'doctor@moh.gov.lk', 'password123', 'DOCTOR', NOW()),
(2, 'Midwife Perera', 'midwife.perera@moh.gov.lk', 'password123', 'MIDWIFE', NOW()),
(3, 'Midwife Kumari', 'midwife.kumari@moh.gov.lk', 'password123', 'MIDWIFE', NOW());

-- Create midwife profiles
INSERT INTO midwife_profiles (id, user_id, gn_division) VALUES
(1, 2, 'Malabe East'),
(2, 3, 'Kaduwela');

-- ============================================================
-- SETUP COMPLETE!
-- Tables are now ready for the application to use
-- ============================================================
